export const MOON_NPCS = [
  ...
  },
  {
    ...
    home: { x: -12, z: -10 },
    schedule: [
      { at: 0, x: -12, z: -10, face: Math.PI * 0.5, act: "work" },
      { at: 480, x: -18, z: -8, face: 0, act: "work" },
      { at: 720, x: -15, z: 3, face: Math.PI, act: "walk" },
      { at: 1080, x: -12, z: -10, face: 0, act: "work" },
      { at: 1320, x: -12, z: -10, face: 0, act: "rest" },
    ],
    lines: [
  ...
  },
  {
    ...
    home: { x: 15, z: -5 },
    schedule: [
      { at: 0, x: 15, z: -5, face: Math.PI, act: "rest" },
      { at: 600, x: 12, z: 0, face: 0, act: "work" },
      { at: 900, x: 15, z: -5, face: Math.PI, act: "work" },
      { at: 1200, x: 15, z: -5, face: 0, act: "rest" },
    ],
    lines: [
  ...
  },
  {
    ...
    home: { x: -8, z: 3 },
    schedule: [
      { at: 0, x: -8, z: 3, face: Math.PI, act: "work" },
      { at: 480, x: -5, z: -5, face: 0, act: "work" },
      { at: 900, x: -8, z: 3, face: Math.PI, act: "work" },
      { at: 1320, x: -8, z: 3, face: 0, act: "rest" },
    ],
    lines: [
  ...
  },
  {
    ...
    home: { x: 5, z: 3 },
    schedule: [
      { at: 0, x: 5, z: 3, face: Math.PI * 0.5, act: "work" },
      { at: 600, x: 8, z: -3, face: 0, act: "work" },
      { at: 900, x: 5, z: 3, face: Math.PI * 0.5, act: "work" },
      { at: 1320, x: 5, z: 3, face: 0, act: "rest" },
    ],
    lines: [
  ...
  },
  {
    ...
    home: { x: -3, z: 8 },
    schedule: [
      { at: 0, x: -3, z: 8, face: Math.PI, act: "walk" },
      { at: 360, x: 10, z: 15, face: 0, act: "work" },
      { at: 600, x: -15, z: 10, face: Math.PI * 0.5, act: "work" },
      { at: 900, x: 5, z: -15, face: 0, act: "work" },
      { at: 1200, x: -3, z: 8, face: 0, act: "rest" },
    ],
    lines: [
      "我在拍月球風景！銀河當背景超美的～",
      "你知道嗎？從月球看地球只有拳頭大小。",
  ...
  },
  {
    ...
    home: { x: 12, z: -12 },
    schedule: [
      { at: 0, x: 12, z: -12, face: 0, act: "work" },
      { at: 480, x: 15, z: -15, face: Math.PI, act: "work" },
      { at: 900, x: 12, z: -12, face: 0, act: "work" },
      { at: 1320, x: 12, z: -12, face: 0, act: "rest" },
    ],
    lines: [
  ...
  },
  {
    ...
    home: { x: 0, z: 15 },
    schedule: [
      { at: 0, x: 0, z: 15, face: Math.PI, act: "work" },
      { at: 480, x: -5, z: 12, face: 0, act: "walk" },
      { at: 720, x: 5, z: 12, face: Math.PI, act: "walk" },
      { at: 1080, x: 0, z: 15, face: Math.PI, act: "work" },
      { at: 1320, x: 0, z: 15, face: 0, act: "rest" },
    ],
    lines: [
      "我是月球基地的飛行員，負責開太空梭！",
      "從月球飛到地球只要3天，超快的！",
